...
TEST(subtree, array)
{
    ...
    MAGIC_CHECK(subtree<0>(x), 1);
    MAGIC_CHECK(x | subtree<0>, 1);
    MAGIC_CHECK(x | subtree<3>, 1);
    MAGIC_CHECK(x | subtree<1>, 2);
    MAGIC_CHECK(x | subtree<4>, 2);
    MAGIC_CHECK(x | subtree<-2>, 2);
    MAGIC_CHECK(x | subtree<2>, 3);
    ...
    MAGIC_TCHECK(decltype(std::move(std::as_const(x)) | subtree<0>), int);

    MAGIC_TCHECK(decltype(x | refer | subtree<0>), int&);
    MAGIC_TCHECK(decltype(std::as_const(x) | refer | subtree<0>), const int&);
...
TEST(subtree, tuple_like)
{
    float y{ 3.1f };
    double z{ 1.4 };
    std::tuple<int, float&, double&&> x{ 233, y, std::move(z) };
    ...
    MAGIC_TCHECK(decltype(x | refer | subtree<1>), float&);
    MAGIC_TCHECK(decltype(std::as_const(x) | refer | subtree<1>), float&);
    MAGIC_TCHECK(decltype(std::move(x) | refer | subtree<1>), float&);
    MAGIC_TCHECK(decltype(std::move(std::as_const(x)) | refer | subtree<1>), float&);
    ...
    MAGIC_TCHECK(decltype(x | refer | subtree<2>), double&);
    MAGIC_TCHECK(decltype(std::as_const(x) | refer | subtree<2>), double&);
    MAGIC_TCHECK(decltype(std::move(x) | refer | subtree<2>), double&&);
    MAGIC_TCHECK(decltype(std::move(std::as_const(x)) | refer | subtree<2>), double&&);
}
